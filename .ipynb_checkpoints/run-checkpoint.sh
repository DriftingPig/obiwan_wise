...
export PYTHONPATH=$CSCRATCH/Obiwan/dr9_LRG/obiwan_code/obiwan_dr9m/legacypipe/py:/usr/local/lib/python:/usr/local/lib/python3.6/dist-packages:/src/unwise_psf/py:.
...
export name_for_run=debug_nonoise
export dataset=dr9
export nobj=50
export threads=32
export rsdir=new_code_test
